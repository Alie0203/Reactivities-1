...
export default function ActivityForm({ activity: selectedActivity, closeForm, createOrEdit }: Props) {
    ...
    return (
        <Segment clearing>
            {/* clearing clears any previous float. Test by removing 'clearing' and see the buttons. */}
            <Form onSubmit={handleSubmt} autoComplete='off'>
                <FormInput placeholder='Title' value={activity.title} name='title' onChange={handleInputChange}/>
                <FormTextArea placeholder='Descripton' value={activity.description} name='description' onChange={handleInputChange} />
